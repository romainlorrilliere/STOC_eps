...
> d <- makeTablePoint(id_output="Gustave_F",mp=pw,user="romain",output=TRUE,altitude_max=800,lastYear=2017)
...
nbp_foret_ps as carre_nb_pts_foret_ps, nbp_ouvert_ps as carre_nb_pts_ouvert_ps, nbp_agri_ps as carre_nb_pts_agricole_ps, nbp_urbain_ps  as carre_nb_pts_urbain_ps,  p.db as data_base_name, '2018-10-29'::varchar(10) as date_export,
		...
		from -- ## begin ## correction abondance obs par seuil
			...
			from -- ## begin ## selection classe de distance et different filtre
				...
				pa.qualite_inventaire_stoc > 0 and
                                ...
                                passage_stoc in (1,2) and  distance_contact in ('U','LESS25','LESS100','MORE100','LESS200','MORE200') and  i.annee >= 2001  and i.annee <= 2017 and c.etude in ('STOC_EPS', 'STOC_ONF')  and  p.altitude <= 800 and p.altitude >= 0
			...
			id_inventaire, code_sp
             ...
             SELECT id_inventaire, code_sp, sum(abondance) as abond
				...
				o.id_point = pa.id_point and o.annee=pa.annee and
				pa.qualite_inventaire_stoc > 0 and
                                 code_sp in  ('MOTFLA' , 'SAXRUB' , 'ANTPRA' , 'OENOEN' , 'PHYTRO')  and    passage_stoc = 2 and  distance_contact in ('U','LESS25','LESS100','MORE100','LESS200','MORE200') and  i.annee >= 2001  and i.annee <= 2017 and c.etude in ('STOC_EPS', 'STOC_ONF')  and  p.altitude <= 800 and p.altitude >= 0
...
om.id_point, annee,code_sp;
 ...
 -->  export/data_FrenchBBS_point_Gustave_F_allSp_2001_2017fr.csv

     #      ==> Duree: 4 minutes
> dpdl <- makeTablePoint(id_output="Gustave_F_PaysDeLoire",mp=pw,user="romain",output=TRUE,altitude_max=800,departement=c(85,44,49,53,72),lastYear=2017)
		...
		from -- ## begin ## correction abondance obs par seuil
			...
			from -- ## begin ## selection classe de distance et different filtre
				...
				pa.qualite_inventaire_stoc > 0 and
                                ...
                                passage_stoc in (1,2) and  distance_contact in ('U','LESS25','LESS100','MORE100','LESS200','MORE200') and  i.annee >= 2001  and i.annee <= 2017 and c.etude in ('STOC_EPS', 'STOC_ONF')  and  p.altitude <= 800 and p.altitude >= 0
 and p.departement in  ('85' , '44' , '49' , '53' , '72')
...
om.id_point, annee,code_sp;
 ...
 -->  export/data_FrenchBBS_point_Gustave_F_PaysDeLoire_allSp_2001_2017fr.csv
