...
vecPackage=c("RODBC","reshape","data.table","rgdal","lubridate","RPostgreSQL","doBy","reshape2")
...
makeTableCarre <- function(con=NULL,user=NULL,mp=NULL,nomDB=NULL,savePostgres=FALSE,output=TRUE,sp=NULL,champSp = "code_sp",nomChampSp="espece",
                           ...
                           departement=NULL,onf=TRUE,distance_contact=NULL,formatTrend = FALSE,isEnglish=FALSE,addAbscence=FALSE,
