...
csi_national <- function(con=NULL,query=TRUE,carre = TRUE,
...
###  con=NULL;query=FALSE;ic =FALSE; carre = TRUE,seuilSignif = 0.05 ; fileName="dataCSI_Brut";firstYear=2001;lastYear=2015;altitude=800;operateur=c("Lorrilliere Romain","lorrilliere@mnhn.fr");id = "Lehikoinen"
    if(carre){
        if(query) {
...
cti_national <- function(con=NULL,query=FALSE,carre = TRUE,
                          firstYear=NULL,lastYear=NULL,altitude=800,departement=NULL,onf=TRUE,distance_contact=NULL,
                          spExcluPassage1=c("MOTFLA","SAXRUB","ANTPRA"),seuilAbondance=.99,
                          champSp = "code_sp", sp=NULL,champsHabitat=FALSE,
                          anglais=TRUE,seuilSignif=0.05,
